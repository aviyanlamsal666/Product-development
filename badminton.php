...
?>
    ...
    <section class="chatbox-section">
      <h2 style="margin-bottom: 30px; text-align: left; width: 50%">Browse the Badminton Match Live Here</h2>
      <div class="chatbox-container">
        <div class="video">
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/L9iCPbLrCDE?si=ni8z-B6YEtv5Q5vy&amp;start=300" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <div class="chatbox">
        <div id="messages">
